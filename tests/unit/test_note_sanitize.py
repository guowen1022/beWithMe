...
MALICIOUS_CASES: list[tuple[str, str, str]] = [
    ...
    ("disallowed tag",      '<div class="card"><details><summary>x</summary></details></div>', "<details"),
...
ALLOWED_CASES: list[tuple[str, str, str]] = [
    ...
    ("code block pre",     '<div class="card"><pre><code>a\nb</code></pre></div>',    "<pre>"),
    ("gfm table",          '<div class="card"><table><thead><tr><th>H</th></tr></thead><tbody><tr><td>x</td></tr></tbody></table></div>', "<table>"),
