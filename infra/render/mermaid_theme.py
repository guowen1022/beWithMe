...
# sandboxed canvas frame, not in note.
MERMAID_CONFIG: dict = {
    "startOnLoad": False,
    "theme": "dark",
    ...
    # Required because (a) note scrubs <foreignObject> as a defense, and
    ...
    "htmlLabels": False,
    # Same tightening the web client uses so note diagrams and
