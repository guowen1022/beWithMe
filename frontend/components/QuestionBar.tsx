...
export default function QuestionBar({
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 border-t border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm transition-all duration-300 z-20 ${
