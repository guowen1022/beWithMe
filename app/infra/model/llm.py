...
Call sites import from here (e.g. `from app.infra.model.llm import generate`)
...
if _PROVIDER == "deepseek":
    ...
    from app.infra.model.deepseek.llm import (  # noqa: F401
        generate,
        generate_cached,
        stream_cached,
        generate_json,
    ...
    from app.infra.model.minimax.llm import (  # noqa: F401
        generate,
        generate_cached,
        stream_cached,
        generate_json,
